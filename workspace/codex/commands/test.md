...
> See `workspace/codex/rules/subagents.md` "Observation Tools" for full reference.
...
> Uses atomic observation pattern from `workspace/codex/rules/problem-solving.md`
