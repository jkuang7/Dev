...
### Modifying workspace/codex Files

```
⚠ About to modify: workspace/codex/commands/foo.md
...
> Uses BEFORE/STEP/AFTER pattern (see `workspace/codex/rules/problem-solving.md` "Verification Format")
...
> See `workspace/codex/rules/problem-solving.md` "Cleanup" for requirements.
